...
class MockContainerComponent : public anh::api::components::ContainerComponentInterface
{
public:
	...
	MOCK_METHOD5(transfer_to, bool(std::shared_ptr<anh::component::Entity>, std::shared_ptr<anh::component::Entity>, std::shared_ptr<anh::api::components::ContainerComponentInterface>, bool, bool));
