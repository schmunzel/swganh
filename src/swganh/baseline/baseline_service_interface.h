...
namespace swganh { namespace baseline {
	...
	public:
		...
		virtual void send_baselines(std::shared_ptr<anh::component::Entity> e, std::list<std::shared_ptr<anh::component::Entity>> recieving_entities, bool duplex) = 0;
		virtual void send_baselines(std::shared_ptr<anh::component::Entity> e, std::shared_ptr<anh::component::Entity> recieving_entity) = 0;
